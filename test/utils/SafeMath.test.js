  ...
  describe("with flag", function () {
    ...
    describe("sub", function () {
      it("subtracts correctly", async function () {
        ...
        expectStruct(await this.safeMath.trySub(a, b), {
          flag: true,
          value: a.sub(b),
        });
      });
    ...
    describe("div", function () {
      it("divides correctly", async function () {
        ...
        expectStruct(await this.safeMath.tryDiv(a, b), {
          flag: true,
          value: a.div(b),
        });
      });
    ...
    describe("mod", function () {
      describe("modulos correctly", async function () {
        it("when the dividend is smaller than the divisor", async function () {
          ...
          expectStruct(await this.safeMath.tryMod(a, b), {
            flag: true,
            value: a.mod(b),
          });
        });
    ...
    describe("mod", function () {
      describe("modulos correctly", async function () {
        it("when the dividend is smaller than the divisor", async function () {
          ...
          expect(await this.safeMath.doMod(a, b)).to.be.bignumber.equal(
            a.mod(b)
          );
        });
  ...
  describe("with custom revert message", function () {
    describe("sub", function () {
      it("subtracts correctly", async function () {
        ...
        expect(
          await this.safeMath.subWithMessage(a, b, "MyErrorMessage")
      ...
      it("reverts if subtraction result would be negative", async function () {
        ...
        await expectRevert(
          this.safeMath.subWithMessage(a, b, "MyErrorMessage"),
          "MyErrorMessage"
        );
      });
    });
    ...
    describe("div", function () {
      it("divides correctly", async function () {
        ...
        expect(
          await this.safeMath.divWithMessage(a, b, "MyErrorMessage")
      ...
      it("reverts on division by zero", async function () {
        ...
        await expectRevert(
          this.safeMath.divWithMessage(a, b, "MyErrorMessage"),
          "MyErrorMessage"
        );
      });
    });
    ...
    describe("mod", function () {
      describe("modulos correctly", async function () {
        it("when the dividend is smaller than the divisor", async function () {
          ...
          expect(
            await this.safeMath.modWithMessage(a, b, "MyErrorMessage")
      ...
      it("reverts with a 0 divisor", async function () {
        ...
        await expectRevert(
          this.safeMath.modWithMessage(a, b, "MyErrorMessage"),
          "MyErrorMessage"
        );
      });
    });
